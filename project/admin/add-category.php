...
<head>
    ...
    <title>Waste eliminator | Add Waste Category</title>
...
<body>
        ...
        <!--  page-wrapper -->
          <div id="page-wrapper">
            <div class="row">
                 <!-- page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Add Waste Category</h1>
                </div>
                <!--end page header -->
            </div>
            <div class="row">
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Waste Category Name</label> <input type="text" name="catname" value="" class="form-control" required='true'> </div>
