...
<head>
    ...
    <title>Waste Eliminator | Dustbin Report Details</title>
       ...
       <?php include_once('includes/header.php');?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Between Dates Reports of Dustbins</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
...
?>
<h5 align="center" style="color:blue">Dustbin Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
$sql="SELECT * from tblpass where date(CleaningDate) between '$fdate' and '$tdate'";
