...
$sql="insert into tblpass(DustbinID,Location,ContactNumber,Email,IdentityType,IdentityNo,Category,FromDate,ToDate)values(:passnum,:fname,:cnum,:email,:itype,:icnum,:cat,:fdate,:tdate)";
...
<head>
    ...
    <title>Waste Eliminator | Add Dustbin</title>
...
<body>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Dustbin location</label> <input type="text" name="fullname" value="" class="form-control" required='true'> </div>
    <div class="form-group"> <label for="exampleInputEmail1">Dustbin Number</label> <input type="text" name="cnumber" value="" class="form-control" required='true' maxlength="10" pattern="[0-9]+"> </div>
    <div class="form-group"> <label for="exampleInputEmail1">Email Address of the person who located dustbin</label> <input type="email" name="email" value="" class="form-control" required='true'> </div>
...
<option value="Any Other Govt Issued Doc">Any Other waste</option>
    ...
    <div class="form-group"> <label for="exampleInputEmail1">Identity No.</label> <input type="text" name="icnum" value="" class="form-control" required='true'> </div>
...
<div class="form-group"> <label for="exampleInputEmail1">Allocated Date</label> <input type="date" name="fromdate" value="" class="form-control" required='true'> </div>
<div class="form-group"> <label for="exampleInputEmail1">Allocated till the Date</label> <input type="date" name="todate" value="" class="form-control" required='true'> </div>
